<?php namespace App\Http\Controllers;
	...
	class AdminPostController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Chapter","name"=>"chapter"];
			...
			$this->form[] = ['label'=>'Sub Title','name'=>'sub_title','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'Chapter','name'=>'chapter','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Book','name'=>'book','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];

			$this->form[] = ['label'=>'user_id','name'=>'user_id','type'=>'text','validation'=>'required|string|min:1|max:70','width'=>'col-sm-10',"type"=>"hidden","value"=>CRUDBooster::myId()];
			$this->form[] = ['label'=>'title','name'=>'slug','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10',"type"=>"hidden"];
			...
			//$this->form[] = ["label"=>"Chapter","name"=>"chapter","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Book","name"=>"book","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
